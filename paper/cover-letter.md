...
The software artifact is MIT-licensed and Zenodo-archived (doi:`__ZENODO_DOI__`) at the commit used to generate every figure. The repository at `github.com/strikerdlm/selectron` contains the full source, the test suite (355+ vitest + 20 Playwright tests), the V&V dossier, and reproducibility instructions.
