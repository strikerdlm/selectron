...
The software artifact is MIT-licensed and archived at Zenodo (DOI assigned upon archival) at the commit used to generate every figure. The repository at `github.com/strikerdlm/selectron` contains the full source, the test suite (355+ vitest unit and property tests plus the Playwright end-to-end suite), the V&V dossier, and reproducibility instructions.
