...
// Demonstration Stage-A catalog.
//
// This is the canonical runtime source for v0.6 rebaseline. It is intentionally
// named as a demo catalog because the Phase-0 taxonomy was never ratified into
// a selection instrument. Use it for uncertain-weight MCDA demonstrations only,
// not for real select/reject recommendations.
export const DEMO_CRITERIA: readonly Criterion[] = [
  {
...
export const DEMO_CRITERION_CATALOG: CriterionCatalog = {
  ...
  version: "2026-06-v0.6-rebaseline",
...
/**
 * Backward-compatible alias for older tests and historical docs.
 * New code should import DEMO_CRITERIA from "@/data/demo-criteria".
 */
export const PLACEHOLDER_CRITERIA = DEMO_CRITERIA;
