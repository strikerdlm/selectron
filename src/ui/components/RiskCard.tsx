      ...
      <div className="mt-6">
        <div className="mono mb-1 flex items-center justify-between text-[12px] text-ink-2">
          <span
            ...
            title="Estimate precision — how tightly the 90% simulation interval is pinned (1 − CI₉₀width/0.30). This is the certainty of the CHI estimate, NOT mission quality: a poor CHI can be estimated just as precisely as a good one."
          >
